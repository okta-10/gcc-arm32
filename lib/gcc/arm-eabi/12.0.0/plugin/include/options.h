...
enum opt_code
{
  ...
  OPT_list = 1752,                           /* -list */
  OPT_mabi_ = 1753,                          /* -mabi= */
  OPT_mabort_on_noreturn = 1754,             /* -mabort-on-noreturn */
  OPT_mapcs = 1755,                          /* -mapcs */
  OPT_mapcs_frame = 1756,                    /* -mapcs-frame */
  OPT_mapcs_reentrant = 1757,                /* -mapcs-reentrant */
  OPT_mapcs_stack_check = 1758,              /* -mapcs-stack-check */
  OPT_march_ = 1759,                         /* -march= */
  OPT_marm = 1760,                           /* -marm */
  OPT_masm_syntax_unified = 1761,            /* -masm-syntax-unified */
  OPT_mbe32 = 1762,                          /* -mbe32 */
  OPT_mbe8 = 1763,                           /* -mbe8 */
  OPT_mbig_endian = 1764,                    /* -mbig-endian */
  ...
  /* OPT_mhard_float = 1778, */              /* -mhard-float */
  OPT_mlibarch_ = 1779,                      /* -mlibarch= */
  OPT_mlittle_endian = 1780,                 /* -mlittle-endian */
  OPT_mlong_calls = 1781,                    /* -mlong-calls */
  OPT_mneon_for_64bits = 1782,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1783,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1784,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1785,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1786,               /* -mprint-tune-info */
  OPT_mpure_code = 1787,                     /* -mpure-code */
  OPT_mrestrict_it = 1788,                   /* -mrestrict-it */
  OPT_msched_prolog = 1789,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1790,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1791,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1792, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1793,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1794,                         /* -mthumb */
  OPT_mthumb_interwork = 1795,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1796,                  /* -mtls-dialect= */
  OPT_mtp_ = 1797,                           /* -mtp= */
  OPT_mtpcs_frame = 1798,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1799,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1800,                         /* -mtune= */
  OPT_munaligned_access = 1801,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1802,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1803,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1804,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1805,              /* -mword-relocations */
  OPT_n = 1806,                              /* -n */
